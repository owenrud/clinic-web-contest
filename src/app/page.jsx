      ...
      >
        ...
        <div className="relative">
          <img
            ...
            alt="..."
          />
          <h1 className="absolute md:left-[15%] top-[65%] md:top-[60%]text-color-white text-color-white text-xs md:text-2xl text-center   z-10 bg-color-secondary rounded-lg w-auto px-3 py-2.5 bg-opacity-50 font-bold">
